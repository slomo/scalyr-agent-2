...
#    - Checks out code branch and runs script to build agent docker image
...
#   $4 : temp dir in which to checkout files
#   $5 : test branch to checkout
#
# e.g. usage
#   smoketest_docker.sh scalyr/scalyr-agent-ci-smoketest:v1.1 json 300 /tmp/workdir master
#----------------------------------------------------------------------------------------
...
# Kill leftover containers and cleanup workdir
/bin/rm -rf $workdir
